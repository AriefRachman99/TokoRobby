...
<body>
  <div class="container">
    ...
    <div class="card-body">
      <input type="text" name="" class="form-control" placeholder="Nama" required /><br>
       <input type="text" name="" class="form-control" placeholder="Phone" required /><br>
        <input type="text" name="" class="form-control" placeholder="Alamat" required /><br>
